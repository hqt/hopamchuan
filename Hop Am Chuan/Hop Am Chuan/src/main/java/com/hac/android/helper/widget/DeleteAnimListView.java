...
public class DeleteAnimListView extends ListView {
    ...
    private static String TAG = LogUtils.makeLogTag(DeleteAnimListView.class);
    ...
    private void animateOtherViews(View viewToRemove) {
        ...
        LogUtils.LOGE(TAG, "Remove position: " + position);
        ...
        observer.addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() {
            ...
            public boolean onPreDraw() {
                LogUtils.LOGE(TAG, "Calling OnPreDrawListener");
                ...
                for (int i = 0; i < getChildCount(); i++) {
                    ...
                    int position = firstVisiblePosition + i;
                    long itemId = mAdapter.getItemId(position);
                    LogUtils.LOGE(TAG, "First: " + firstVisiblePosition + "  position: " + position + "  Id: " + itemId);
