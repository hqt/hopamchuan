...
public class SplashScreen extends AsyncActivity {
    ...
    private static final String TAG = LogUtils.makeLogTag(SplashScreen.class);
    ...
    private void onLongWork() {
        ...
        if (PrefStore.isFirstRun() || (!ResourceUtils.isDatabaseFileExist())) {
            LogUtils.LOGE(TAG, "First Running Database. Create new Database");
            publishProgress(0);
            // copy database
            ...
            LogUtils.LOGE(TAG, "Second Running Database. Nothing Change");
