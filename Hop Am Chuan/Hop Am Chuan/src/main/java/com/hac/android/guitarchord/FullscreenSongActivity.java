...
import com.hac.android.helper.widget.MusicPlayerController;
...
import com.hac.android.utils.ScreenUtils;
...
public class FullscreenSongActivity extends SlidingMenuActionBarActivity
    ...
    private static String TAG = LogUtils.makeLogTag(FullscreenSongActivity.class);
...
//    }
    ...
    @Override
    public void start() {
        LogUtils.LOGD(TAG, "Start Player");
    ...
    @Override
    public void pause() {
        LogUtils.LOGD(TAG, "Pause Player");
