...
import com.hac.android.provider.helper.SQLiteAssetHelper;
import com.hac.android.utils.LogUtils;

/**
 * helper for managing {@link SQLiteDatabase} that stores data for
 * {@link HopAmChuanProvider}.
 */
public class HopAmChuanDatabase extends SQLiteAssetHelper {

    private static final String TAG = LogUtils.makeLogTag(HopAmChuanDatabase.class);
