...
/**
 * self-adapter use for Merge Adapter. Using Decorator Pattern
 * simple exchange this adapter with others. rather use library
 *
...
public class DecoratorAdapter extends BaseAdapter {
     ...
     */
    public DecoratorAdapter(int count) {
        super();
     ...
     */
    public DecoratorAdapter(List<View> views) {
        super();
